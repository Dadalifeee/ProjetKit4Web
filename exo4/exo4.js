class clothes {
    constructor(image, name, reference, quantity, category) {
        this.image = image;
        this.name = name;
...
let clothes1 = new clothes(myImage, "t-shirt red", "25165165161", 15, "t-shirt");
let clothes2 = new clothes(myImage2, "t-shirt greeen", "156161616515", 12, "poire");
let clothes3 = new clothes(myImage3, "t-shirt blue", "15165165161", 30, "dragont");
let clothes4 = new clothes(myImage4, "t-shirt gray", "95165165161", 20, "OM");
let tabclothes = [];
let tabnewclothes = [];
let tabatt = [];
tabclothes.push(clothes1, clothes2, clothes3, clothes4);
tabatt.push("name", "reference", "quantity", "category");
function generate(tabobjet) {
    ...
    let btnrecherche = function (btncherche, tabobjetbtn, div, tbl, tblBody, bool, recherche) {
...
function displaybutton(tabobjet, tbl1, tblBody1, tbl2, tblBody2, div0, div1, div2, div3, div4) {
    ...
    let btnup = function (btnupp, tabobjetbtn, div, tbl, tblBody, bool, updown) {
