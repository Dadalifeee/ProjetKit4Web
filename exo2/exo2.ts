class clothes{
  ...
  constructor(name: string, reference:string, quantity:number, category:string){
      this.name = name;
...
function generate(tabobjet : Array<clothes>, tabattribut: Array<string>, color : string = "#6495ed", colortext : string = "black", colorcell : string = "#f7f7f7"){
let newtabobjet : Array<string> = [];
...
function changecolor(element : HTMLElement, color: string, color2 : string){
...
function arr_sort(tabobjet, attribu, bool, tbl){
  ...
  return new Promise(function(resolve, reject){
    let newtableobjet : Array<clothes> = [];
...
let clothes1 : clothes = new clothes("t-shirt red", "25165165161", 15, "t-shirt");
let clothes2 : clothes = new clothes("t-shirt greeen", "156161616515", 12, "poire");
let clothes3 : clothes = new clothes("t-shirt blue", "15165165161", 30, "dragont");
let clothes4 : clothes = new clothes("t-shirt gray", "95165165161", 20, "OM");
